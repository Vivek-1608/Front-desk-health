...
var DoctorController = /** @class */ (function () {
    ...
    DoctorController.prototype.getAll = function () {
        return this.doctorService.findAll();
    };
    DoctorController.prototype.getOne = function (id) {
        return this.doctorService.findOne(+id);
    };
    DoctorController.prototype.create = function (doctor) {
        return this.doctorService.create(doctor);
    };
    DoctorController.prototype.update = function (id, updateData) {
    ...
    ], DoctorController.prototype, "getAll", null);
    __decorate([
        (0, common_1.Get)(':id'),
        ...
        __metadata("design:returntype", void 0)
    ], DoctorController.prototype, "getOne", null);
    __decorate([
        (0, common_1.Post)(),
