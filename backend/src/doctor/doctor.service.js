...
var DoctorService = /** @class */ (function () {
    ...
    DoctorService.prototype.create = function (doctor) {
        var newDoctor = this.doctorRepository.create(doctor);
        return this.doctorRepository.save(newDoctor);
    };
    DoctorService.prototype.update = function (id, updateData) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.doctorRepository.update(id, updateData)];
                    case 1:
                        _a.sent();
    ...
    DoctorService.prototype.remove = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.doctorRepository.delete(id)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
